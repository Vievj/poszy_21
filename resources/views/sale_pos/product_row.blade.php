...
<tr class="product_row" data-row_index="{{$row_count}}" @if(!empty($so_line)) data-so_id="{{$so_line->transaction_id}}" @endif>
	...
	<td>
		...
		<div class="input-group input-number">
			<span class="input-group-btn"><button title='weight machine'  type="button" class="btn btn-default btn-flat quantity-down"><i class="fa fa-minus text-danger"></i></button></span>
		<input type="text" data-min="1" 
			...
			@endif 
		>
		<span class="input-group-btn"><button onclick= type="button" class="btn btn-default btn-flat quantity-up"><i class="fa fa-plus text-success"></i></button></span>

		<span class="input-group-btn"><button onclick='showMachine($(this).parent("span").parent("div").find("input"))' type="button" class="btn btn-default btn-flat"><i class="fa fa-weight weight-port" style="color:#ffc107"></i></button></span>
		</div>
